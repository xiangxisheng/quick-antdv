...
$data['columns'][] = array('title' => 'Number', 'dataIndex' => 'job_number', 'sql_where' => 'job_number LIKE ?');
$data['columns'][] = array('title' => 'Name', 'dataIndex' => 'person_name', 'sql_select' => "MIN(person_name)", 'sql_where' => 'person_name LIKE ?');
